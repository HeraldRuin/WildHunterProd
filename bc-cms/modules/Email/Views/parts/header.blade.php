...
<div class="" style="">
    <div class="b-container">
        <div class="b-header" bgcolor="{{ $main_color }}" x-apple-data-detectors="false" style="background-color:{{ $main_color }};color:#ffffff;padding:30px;">
            {!! $email_header ? $email_header : sprintf('<h1 class="site-title" style="margin:0;display:block;text-align:center;color:#ffffff !important;">%s</h1>', setting_item('site_title', env('APP_NAME', 'Не установлено имя'))) !!}
        </div>
    </div>
</div>
